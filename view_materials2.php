...
// --- FIX: Define the base path for your files here ---
// **IMPORTANT**: Change 'uploads/' to your actual storage directory name.
...
while ($row = $result->fetch_assoc()) {
    ...
    // FIX IMPLEMENTATION: Create a corrected, full path for the link
...
<body>
    ...
    <div class="Home_container">
        ...
        <p>Access and download educational resources uploaded for your class.</p>
